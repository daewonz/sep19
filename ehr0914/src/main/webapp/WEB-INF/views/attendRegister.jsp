...
<%@ include file="sidebar.jsp" %>
 <article id="article">
   ...
   <div class="page-div2">
      ...
      <c:forEach var="i" begin="${ph.startPage}" end="${ph.endPage}">
         <a onclick="pageCss()" href="<c:url value='./attendRegister?page=${i}&pageSize=${ph.pageSize}&searchData=${selectedMap.searchData}&atregdate=${selectedMap.atregdate}&atregsts=${selectedMap.atregsts}&atregacpt=${selectedMap.atregacpt}&atregcontent=${selectedMap.atregcontent}&atregcomment=${selectedMap.atregcomment}'/>">${i}</a>
      </c:forEach>
      <c:if test="${ph.showNext}">
